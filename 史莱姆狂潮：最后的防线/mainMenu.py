...
pygame.mixer.music.load("bgmusic.mp3")  # 或 "Images/bgm.mp3"
...
font_20 = pygame.font.Font("IBMPlexSans-Regular.ttf", 20)  # 加载 20 号字体
font_30 = pygame.font.Font("IBMPlexSans-Regular.ttf", 30)  # 加载 30 号字体
font_60 = pygame.font.Font("IBMPlexSans-Regular.ttf", 60)  # 加载 60 号字体
...
def MainMenu():
    ...
    Images = load_images("Images")  # 加载 Images 文件夹下所有图片资源
    game_run = True  # 主循环标志
    ...
    file = open("SaveFile/saveFile.txt", "r")  # 打开存档文件
