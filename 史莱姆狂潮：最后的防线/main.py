            ...
            if self.selecting == True and cash >= self.Costs[self.selected-1]*Multiplier[Difficulties.index(Diff)]:
                if self.selected == 1:
                    # pygame.draw.rect(gameDisplay, (200, 0, 0), (pos[0]-15, pos[1]-15, 30, 30), 0)
                     gameDisplay.blit(pygame.transform.scale(Images["Tower1"], (80, 80)), (pos[0]-15, pos[1]-15))
                    ...
                    gameDisplay.blit(pygame.transform.scale(Images["IceTower"], (30, 30)), (pos[0]-15, pos[1]-15))
                     ...
                     gameDisplay.blit(pygame.transform.scale(Images["Tower5"], (50, 61)), (pos[0]-15, pos[1]-15))
                elif self.selected == 6:
                     gameDisplay.blit(pygame.transform.scale(Images["Tower6"], (38, 38)), (pos[0]-15, pos[1]-15))
                    ...
                    # pygame.draw.rect(gameDisplay, (100, 150, 200), (pos[0]-15, pos[1]-15, 30, 30), 0)
                     gameDisplay.blit(pygame.transform.scale(Images["Tower8"], (80, 80)), (pos[0]-15, pos[1]-15))
...
def game_loop(load, mapName, Diff=""):
    ...
    while game_run:
        ...
        for j, row in enumerate(Board):
            for i, tile in enumerate(row):
                if Board[j][i] == 0:
                    gameDisplay.blit(pygame.transform.scale(Images["Grass"], (40, 40)), (i*40, j*40))
                elif Board[j][i] == 1:
                    gameDisplay.blit(pygame.transform.scale(Images["Path"], (40, 40)), (i*40, j*40))
                else:
                    gameDisplay.blit(pygame.transform.scale(Images["Grass"], (40, 40)), (i*40, j*40))
        ...
        for j in range(4):
            for i in range(2):
                if selection.step == 0:
                    ...
                    if [i, j] not in [[0,0], [1,3], [0,2], [1,2], [0, 1], [1, 0], [1, 1], [0, 3]]:
                        pygame.draw.rect(gameDisplay, ColorBoard[j][i], (660+i*100+10, 150+j*70+10, 40, 40), 0)
                          # 塔1缩略图（左上角）用贴图
                    elif i == 0 and j == 0:
                        gameDisplay.blit(pygame.transform.scale(Images["Tower1"], (80, 80)), (640+i*100+10, 130+j*70+10))
                    elif i == 1 and j == 3:
                        gameDisplay.blit(pygame.transform.scale(Images["Tower8"], (80, 80)), (640+i*100+10, 130+j*70+10))
                    elif i == 0 and j == 2:
                        gameDisplay.blit(pygame.transform.scale(Images["Tower5"], (50, 61)), (650+i*100+10, 140+j*70+10))
                    elif i == 1 and j == 2:
                        gameDisplay.blit(pygame.transform.scale(Images["Tower6"], (38, 38)), (660+i*100+10, 150+j*70+10))
                    elif j == 0 and i == 1:
                        ...
                        gameDisplay.blit(pygame.transform.scale(Images["IceTower"], (60, 60)), (640+i*100+15, 130+j*70+20))
                    elif j == 3 and i == 0:
